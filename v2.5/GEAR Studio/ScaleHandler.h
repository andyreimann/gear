...
class ManagedEntity;
/** This class is responsible for handling the sclae of meshes through the handlers of the Editor
 * @created:	2014/01/12
...
class ScaleHandler : private G2S::HandlerBase
{
	public:
		 ...
		 */
		ScaleHandler(unsigned int xAxisHandlerId, unsigned int yAxisHandlerId, unsigned int zAxisHandlerId);
