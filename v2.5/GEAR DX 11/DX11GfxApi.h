...
extern "C"
{
	...
	GEARDX11DLL_API void	SetCullFaceEnabled(bool mode);
	GEARDX11DLL_API void	SetDepthWritesEnabled(bool mode);
	GEARDX11DLL_API void	SetDepthBias(bool enabled, float depthBias, float depthBiasClamp, float slopeScaledDepthBias);
