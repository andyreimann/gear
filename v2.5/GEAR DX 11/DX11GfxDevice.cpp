...
DX11GfxDevice::DX11GfxDevice(HWND hWnd) :
	mHwnd(hWnd)
{
...
void
DX11GfxDevice::clearColor(glm::vec4 const& color) 
{
	mDeviceContext->ClearRenderTargetView(mBackbuffer, glm::value_ptr(color) );
}
