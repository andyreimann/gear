...
void
TriangleTools::calculateTangentAndBinormalForTriangle(
	unsigned int i1, 
	unsigned int i2,
	unsigned int i3,
	glm::vec3 const& p1, 
	...
	std::vector<glm::vec3>& tangents) 
{
	...
	if(TriangleTools::isDegenerated(p1,p2,p3) ) 
	{
...
bool
TriangleTools::isDegenerated(glm::vec3 const& p1, glm::vec3 const& p2, glm::vec3 const& p3) 
{
