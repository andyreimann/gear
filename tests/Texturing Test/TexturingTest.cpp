	...
	mEditor(&window, ASSET_PATH + "G2Editor/")
{
	...
	createTexturedPlane(glm::vec3(-3.f*width, -1.f, 0.f), width, height, mTexImporter.import(ASSET_PATH + "Resources/ac-unity-hd.jpg", G2Core::DataFormat::Internal::R8_UI, G2Core::FilterMode::LINEAR, G2Core::FilterMode::LINEAR), "R8_UI MIN: LINEAR, Mag: LINEAR");
	createTexturedPlane(glm::vec3(-2.f*width, -1.f, 0.f), width, height, mTexImporter.import(ASSET_PATH + "Resources/ac-unity-hd.jpg", G2Core::DataFormat::Internal::R8_I, G2Core::FilterMode::NEAREST, G2Core::FilterMode::NEAREST), "R8_I MIN: NEAREST, Mag: NEAREST");
	createTexturedPlane(glm::vec3(-1.f*width, -1.f, 0.f), width, height, mTexImporter.import(ASSET_PATH + "Resources/ac-unity-hd.jpg", G2Core::DataFormat::Internal::R16_UI, G2Core::FilterMode::LINEAR, G2Core::FilterMode::NEAREST), "R16_UI MIN: LINEAR, Mag: NEAREST");
	createTexturedPlane(glm::vec3(0.f*width, -1.f, 0.f), width, height, mTexImporter.import(ASSET_PATH + "Resources/ac-unity-hd.jpg", G2Core::DataFormat::Internal::R16_I, G2Core::FilterMode::NEAREST, G2Core::FilterMode::LINEAR), "R16_I MIN: NEAREST, Mag: LINEAR");
	
	// visualize normal min and mag filter using assassins creed HD image using mipmaps
	createTexturedPlane(glm::vec3(-3.f*width, -1.f, -1.f*height), width, height, mTexImporter.import(ASSET_PATH + "Resources/ac-unity-hd.jpg", G2Core::DataFormat::Internal::R16_F, G2Core::FilterMode::LINEAR_MIPMAP_LINEAR, G2Core::FilterMode::LINEAR), "R16_F MIN: LINEAR_MIPMAP_LINEAR, Mag: LINEAR");
	createTexturedPlane(glm::vec3(-2.f*width, -1.f, -1.f*height), width, height, mTexImporter.import(ASSET_PATH + "Resources/ac-unity-hd.jpg", G2Core::DataFormat::Internal::R32_UI, G2Core::FilterMode::NEAREST_MIPMAP_NEAREST, G2Core::FilterMode::NEAREST), "R32_UI MIN: NEAREST_MIPMAP_NEAREST, Mag: NEAREST");
	createTexturedPlane(glm::vec3(-1.f*width, -1.f, -1.f*height), width, height, mTexImporter.import(ASSET_PATH + "Resources/ac-unity-hd.jpg", G2Core::DataFormat::Internal::R32_I, G2Core::FilterMode::LINEAR_MIPMAP_LINEAR, G2Core::FilterMode::NEAREST), "R32_I MIN: LINEAR_MIPMAP_LINEAR, Mag: NEAREST");
	createTexturedPlane(glm::vec3(0.f*width, -1.f, -1.f*height), width, height, mTexImporter.import(ASSET_PATH + "Resources/ac-unity-hd.jpg", G2Core::DataFormat::Internal::R8G8_UI, G2Core::FilterMode::NEAREST_MIPMAP_NEAREST, G2Core::FilterMode::LINEAR), "R8G8_UI MIN: NEAREST_MIPMAP_NEAREST, Mag: LINEAR");
	createTexturedPlane(glm::vec3(-3.f*width, -1.f, -2.f*height), width, height, mTexImporter.import(ASSET_PATH + "Resources/ac-unity-hd.jpg", G2Core::DataFormat::Internal::R8G8_I, G2Core::FilterMode::LINEAR_MIPMAP_NEAREST, G2Core::FilterMode::LINEAR), "R8G8_I MIN: LINEAR_MIPMAP_NEAREST, Mag: LINEAR");
	createTexturedPlane(glm::vec3(-2.f*width, -1.f, -2.f*height), width, height, mTexImporter.import(ASSET_PATH + "Resources/ac-unity-hd.jpg", G2Core::DataFormat::Internal::R16G16_UI, G2Core::FilterMode::NEAREST_MIPMAP_LINEAR, G2Core::FilterMode::NEAREST), "R16G16_UI MIN: NEAREST_MIPMAP_LINEAR, Mag: NEAREST");
	createTexturedPlane(glm::vec3(-1.f*width, -1.f, -2.f*height), width, height, mTexImporter.import(ASSET_PATH + "Resources/ac-unity-hd.jpg", G2Core::DataFormat::Internal::R16G16_I, G2Core::FilterMode::LINEAR_MIPMAP_NEAREST, G2Core::FilterMode::NEAREST), "R16G16_I MIN: LINEAR_MIPMAP_NEAREST, Mag: NEAREST");
	createTexturedPlane(glm::vec3(0.f*width, -1.f, -2.f*height), width, height, mTexImporter.import(ASSET_PATH + "Resources/ac-unity-hd.jpg", G2Core::DataFormat::Internal::R16G16_F, G2Core::FilterMode::NEAREST_MIPMAP_LINEAR, G2Core::FilterMode::LINEAR), "R16G16_F MIN: NEAREST_MIPMAP_LINEAR, Mag: LINEAR");
	...
	createTexturedPlane(glm::vec3(-2.f*width, -1.f, -3.f*height), width, height, mTexImporter.import(ASSET_PATH + "Resources/ac-unity-hd.jpg", G2Core::DataFormat::Internal::R32G32_UI, G2Core::FilterMode::LINEAR, G2Core::FilterMode::LINEAR, false, G2Core::WrapMode::REPEAT, G2Core::WrapMode::REPEAT), "R32G32_UI");
	createTexturedPlane(glm::vec3(-1.f*width, -1.f, -3.f*height), width, height, mTexImporter.import(ASSET_PATH + "Resources/ac-unity-hd.jpg", G2Core::DataFormat::Internal::R32G32_I, G2Core::FilterMode::LINEAR, G2Core::FilterMode::LINEAR, false, G2Core::WrapMode::REPEAT, G2Core::WrapMode::REPEAT), "R32G32_I");
	...
	createTexturedPlane(glm::vec3(-2.f*width, -1.f, -4.f*height), width, height, mTexImporter.import(ASSET_PATH + "Resources/ac-unity-hd.jpg", G2Core::DataFormat::Internal::R32G32B32A32_UI, G2Core::FilterMode::LINEAR, G2Core::FilterMode::LINEAR, true, G2Core::WrapMode::REPEAT, G2Core::WrapMode::REPEAT), "R32G32B32A32_UI");
	createTexturedPlane(glm::vec3(-1.f*width, -1.f, -4.f*height), width, height, mTexImporter.import(ASSET_PATH + "Resources/ac-unity-hd.jpg", G2Core::DataFormat::Internal::R32G32B32A32_I, G2Core::FilterMode::LINEAR, G2Core::FilterMode::LINEAR, true, G2Core::WrapMode::REPEAT, G2Core::WrapMode::REPEAT), "R32G32B32A32_I");
	createTexturedPlane(glm::vec3(0.f*width, -1.f, -4.f*height), width, height, mTexImporter.import(ASSET_PATH + "Resources/ac-unity-hd.jpg", G2Core::DataFormat::Internal::R32G32B32A32_F, G2Core::FilterMode::LINEAR, G2Core::FilterMode::LINEAR, true, G2Core::WrapMode::REPEAT, G2Core::WrapMode::REPEAT), "R32G32B32A32_F");
	
	// compressed images
	createTexturedPlane(glm::vec3(-3.f*width, -1.f, -5.f*height), width, height, mTexImporter.import(ASSET_PATH + "Resources/ac-unity-hd.jpg", G2Core::DataFormat::Internal::R32G32B32_F, G2Core::FilterMode::LINEAR, G2Core::FilterMode::LINEAR, false, G2Core::WrapMode::REPEAT, G2Core::WrapMode::REPEAT), "R32G32B32_F");
