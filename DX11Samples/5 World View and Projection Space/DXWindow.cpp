...
DXWindow::initGraphics()
{
	...
	// SET TRANSFORMATIONS
	{
		...
		//Set the View matrix
		D3DXMatrixLookAtLH(&mCamView, &D3DXVECTOR3(0.0f, 0.0f, -0.5f), &D3DXVECTOR3(0.0f, 0.0f, 0.0f), &D3DXVECTOR3(0.0f, 1.0f, 0.0f));

		//Set the Projection matrix
		D3DXMatrixPerspectiveFovLH(&mCamProjection, 0.4f*3.14f, (float)mWidth / (float)mHeight, 0.1f, 1000.0f);
